...
.fmProyecto {
	...
	/* Asegura que los elementos estén en una columna */
}
...
.containerform {
	...
	width: 50%;
	margin-bottom: 20px;
	/* Asegura que haya espacio entre el formulario y el footer */
}
</style>
</head>
<body id="page-top">
		...
		<div class="containerform mt-5">
			...
			<form action="editarProyecto" method="POST"
				...
				<div class="mb-3">
					...
					<div class="input-group">
						<span class="input-group-text"><i class="fas fa-pen"></i></span> <input
							...
							name="nombreProyecto" value="${proyecto.nombreProyecto}" required>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<div class="input-group">
						...
						<textarea class="form-control" id="descripcionProyecto"
							name="descripcionProyecto" rows="3" required>${proyecto.descripcionProyecto}</textarea>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<c:if test="${not empty proyecto.imagen1Proyecto}">
						<p>
							Imagen actual: <img src="${proyecto.imagen1Proyecto}" width="100">
						</p>
					</c:if>
				</div>
				...
				<div class="mb-3">
					...
					<c:if test="${not empty proyecto.imagen2Proyecto}">
						<p>
							Imagen actual: <img src="${proyecto.imagen2Proyecto}" width="100">
						</p>
					</c:if>
				</div>
				...
				<div class="mb-3">
					...
					<c:if test="${not empty proyecto.imagen3Proyecto}">
						<p>
							Imagen actual: <img src="${proyecto.imagen3Proyecto}" width="100">
						</p>
					</c:if>
				</div>
				...
				<div class="mb-3">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control"
							...
							value="${proyecto.fechaFinalizacionProyecto}" required>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<div class="input-group">
						<span class="input-group-text"><i
							...
							value="${proyecto.metaRecaudacionProyecto}" required>
					</div>
				</div>
				...
				<div class="mb-3">
					...
					<div class="input-group">
						...
						<select class="form-select" id="categoriaProyecto"
							...
							<option value="1" ${proyecto.idCategoria == 1 ? 'selected' : ''}>Tecnologia</option>
