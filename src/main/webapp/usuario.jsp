            ...
            <div class="col-md-5">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted">
                            @<%=(usuario != null) ? usuario.getNicknameUsuario() : "Sin nickname"%>
                        </p>
                        <p><strong>Correo:</strong>
                            <%=(usuario != null) ? usuario.getMailUsuario() : "No disponible"%>
                        </p>
                        <p><strong>Fecha de Nacimiento:</strong>
                            <%=(usuario != null) ? usuario.getFechaNacimientoUsuario() : "No disponible"%>
                        </p>
                        <p><strong>Teléfono:</strong>
                            <%=(usuario != null) ? usuario.getTelefonoUsuario() : "No disponible"%>
                        </p>
                        <p><strong>DNI:</strong>
                            <%=(usuario != null) ? usuario.getDniUsuario() : "No disponible"%>
                        </p>
                        <p><strong>Descripción:</strong>
                            <%=(usuario != null) ? usuario.getDescripcionUsuario() : "No disponible"%>
                        </p>
                        <p><strong>Fecha de Alta:</strong>
                            <%=(usuario != null) ? usuario.getFechaAltaUsuario() : "No disponible"%>
                        </p>

                        <a href="/webboostly/editarUsuario?id=<%=usuario.getId()%>"
                           class="btn btn-primary">Editar Perfil</a>
                        <a href="?logout=true" class="btn btn-custom">Cerrar Sesión</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group" id="myList" role="tablist">
                            ...
                            <a class="list-group-item list-group-item-action"
                               data-toggle="list"
                               href="proyectoMostrar?id=<%=proyecto.getIdProyecto()%>"
                               role="tab">
                            ...
                            %>
                            <a>No hay proyectos asociados a este usuario.</a>
                            <%
                                }
                            %>
                        </div>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy; BOOSTLY 2025
                </div>
            </div>
        </div>
    </footer>
