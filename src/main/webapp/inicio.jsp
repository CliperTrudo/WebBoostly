	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top"><img
				src="assets/img/logoo.png" alt="..."
				style="height: 35%; width: 35%;" /></a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
					...
					<c:if test="${empty sessionScope.datos}">
						<li class="nav-item"><a class="nav-link" href="login.jsp">login</a></li>
					</c:if>
					<c:if test="${not empty sessionScope.datos}">
						<li class="nav-item"><a class="nav-link" href="login.jsp">YO</a></li>
					</c:if>
	...
	<header class="masthead">
		<div class="container">
			...
			<div class="masthead-heading text-uppercase">Comparte Tu
				Proyecto</div>
			<a class="btn btn-primary btn-xl text-uppercase" href="#services">saber
				más</a>
		</div>
	</header>
	<!-- Services-->
	<section class="page-section" id="services">
		<div class="container">
			<div class="text-center">
				...
				<h3 class="section-subheading text-muted">Conoce los asldf
					laskdjflasd</h3>
			</div>
