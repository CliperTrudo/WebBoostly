...
/**
 * Controlador encargado de manejar la solicitud de restablecimiento de contraseña.
 * Este controlador procesa tanto las solicitudes GET como POST para la recuperación de contraseñas.
 * En la solicitud GET, redirige al formulario donde el usuario puede introducir su nueva contraseña.
 * En la solicitud POST, procesa el token de recuperación y la nueva contraseña para restablecer la contraseña del usuario.
 * 
...
public class NuevaContraseñaController extends HttpServlet {
    ...
    /**
     * Método encargado de manejar la solicitud GET. Redirige al usuario al formulario de restablecimiento de contraseña.
     * 
    ...
    /**
     * Método encargado de manejar la solicitud POST para restablecer la contraseña del usuario.
     * Verifica el token de recuperación y actualiza la contraseña si el token es válido.
     * 
     * @param request La solicitud HTTP recibida.
     * @param response La respuesta HTTP a enviar.
     * @throws ServletException Si ocurre un error durante el procesamiento de la solicitud.
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Si el resultado es exitoso, mostrar mensaje de éxito, de lo contrario, mensaje de error
        if (resultado) {
