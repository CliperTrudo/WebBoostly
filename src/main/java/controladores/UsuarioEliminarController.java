...
/**
 * Servlet que elimina un usuario invocando al endpoint DELETE
 * /api/usuarios/{id}. Mapea la URL /admin/borrarUsuario?id={idUsuario}.
 */
...
public class UsuarioEliminarController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// 3) Redirigir de vuelta al panel de admin (quizá mostrando un mensaje en
			// session/flash)
			response.sendRedirect(request.getContextPath() + "/admin");
	...
	// Si prefieres procesar por POST en lugar de GET, puedes añadir doPost igual a
	// doGet
	@Override
