...
/**
 * Controlador encargado de gestionar los proyectos de los usuarios. Este
 * controlador maneja las solicitudes GET y POST relacionadas con los proyectos.
 * En la solicitud GET, redirige al formulario donde el usuario puede crear un
 * nuevo proyecto. En la solicitud POST, procesa los datos del proyecto y lo
...
public class ProyectoController extends HttpServlet {
	...
	/**
	 * Método encargado de manejar la solicitud POST. Recibe los datos del
	 * formulario para crear un nuevo proyecto. Valida la sesión del usuario,
	 * obtiene los datos del formulario y los envía a la API para ser registrados.
	 * 
	 * @param request  La solicitud HTTP recibida.
	 * @param response La respuesta HTTP a enviar.
	 * @throws ServletException Si ocurre un error durante el procesamiento de la
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (proyectoResultado != null && proyectoResultado.getIdProyecto() != null) {
				...
				// Si devuelve null, significa que algo falló en la API o no se devolvió un
				// objeto válido
