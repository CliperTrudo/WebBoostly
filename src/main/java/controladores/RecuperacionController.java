...
/**
 * Controlador encargado de gestionar la recuperación de contraseñas. Este
 * controlador maneja la solicitud GET para mostrar la página de recuperación de
 * contraseña, y la solicitud POST para generar un token de recuperación y
 * enviarlo por correo electrónico.
 * 
 * @author Sergio Alfonseca
 */
@WebServlet("/recuperar-contrasena") // Anotación para registrar el servlet en el mapeo de URL
										// "/recuperar-contrasena"
public class RecuperacionController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Método que maneja la solicitud GET. Redirige a la página de recuperación de
	 * contraseña.
	 * 
	...
	/**
	 * Método que maneja la solicitud POST. Recibe el correo electrónico, genera un
	 * token de recuperación, y lo envía a través del servicio de recuperación de
	 * contraseña.
	 * 
	 * @param request  La solicitud HTTP recibida.
	 * @param response La respuesta HTTP a enviar.
		...
		try {
			...
			if (resultado) {
				request.setAttribute("mensaje",
						"Se ha enviado un correo con instrucciones para recuperar la contraseña.");
			} else {
