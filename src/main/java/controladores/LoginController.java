 ...
 * Este controlador procesa tanto las solicitudes GET como POST relacionadas con
 * el login. En el caso de una solicitud GET, redirige al usuario al formulario
 * de login. En una solicitud POST, valida las credenciales ingresadas y, si son
...
public class LoginController extends HttpServlet {
    ...
    /**
     * Método encargado de manejar la solicitud POST para procesar los datos de inicio de sesión.
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Verificar si la contraseña en texto plano coincide con el hash almacenado en la base de datos
